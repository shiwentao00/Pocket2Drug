"""
Plot the Tanimoto similarity distributions of 3 methods of the 2 input pockets.
"""
import argparse
...
if __name__ == '__main__':
    args = get_args()
    pocket1 = args.pocket1
    pocket2 = args.pocket2
    ...
    ax1.set_ylabel('Tanimoto similarity with label ligand')

    for pocket, ax, fig_label in zip([pocket1, pocket2], [ax1, ax2], ['A', 'B']):
        ...
        # plot 3 box plots 
        ax.set_title(f"({fig_label}) {pocket}")
    ...
    # show plot
    plt.savefig(f"./figure3.png", dpi=300, bbox_inches='tight')
    plt.savefig(f"./figure3.tif", dpi=300, bbox_inches='tight')