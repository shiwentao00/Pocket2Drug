...
class TSEvaluation:
    def __init__(self, mol_dir, label_smiles_path, control_path, seq_identity_path=None, num_workers=20):
        ...
        # read data generated by mol rnn 
        with open(control_path, 'r') as f:
            self.control_list = f.readlines()
        self.control_list = [x.strip() for x in self.control_list]
        self.control_list = list(set(self.control_list))
