...
class TSEvaluation:
    def __init__(self, mol_dir, label_smiles_path, seq_identity_path=None, num_workers=20):
...
if __name__ == '__main__':
    ...
    evaluation = TSEvaluation(mol_dir, label_smiles_path, seq_identity_path, 20)
