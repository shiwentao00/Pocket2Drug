...
if __name__=="__main__":
    ...
    best_docking_scores.pop() # the last data is an outlier that squeeze the other data
    fig, ax = plt.subplots()
    ax.set_title('Median Ligand Efficiency')
    ax.set_xlabel('Zinc ligand efficiency')
    ax.set_ylabel('Model ligand efficiency')
    ...
    plt.savefig("median_ligand_efficiency.png", dpi=300)
